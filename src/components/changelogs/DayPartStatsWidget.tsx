...
import { Changelog, getDayPartStats } from '@/types/changelogTypes';

interface DayPartStatsWidgetProps {
  changelogs: Changelog[];
}

export default function DayPartStatsWidget({ changelogs }: DayPartStatsWidgetProps) {
  const stats = getDayPartStats(changelogs);
